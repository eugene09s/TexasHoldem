...
<c:otherwise>btn-outline-success ml-2</c:otherwise>
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <input type="number" id="input-money" maxlength="7" minlength="1" class="border border-primary rounded" value="${userDto.getBalance()}" data-decimals="2" min="0" max="100000" step="0.1">
